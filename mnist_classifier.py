...
class mnist_network:
	...
	def unsupervised_pretraining(self, autoencoder):
		if autoencoder.model.has_key('W1'):
			self.model['W1'] = 	autoencoder.model['W1']
		elif autoencoder.model.has_key('W'):
			self.model['W1'] = 	autoencoder.model['W']
